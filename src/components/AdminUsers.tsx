...
export default function AdminUsers() {
  ...
  const [selectedUserId, setSelectedUserId] = useState<string | null>(() => getAdminUsersSelectionFromUrl().userId)
  const [projects, setProjects] = useState<OnlineProjectResponse[]>([])
  const [selectedProjectId, setSelectedProjectId] = useState<string | null>(() => getAdminUsersSelectionFromUrl().projectId)
  ...
  }, [projects, selectedProjectId, selectedUserId, showToast])
